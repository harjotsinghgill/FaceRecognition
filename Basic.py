...
imgTest = face_recognition.load_image_file("ImageBasic\Elon_Test.png")
...
cv2.putText(imgTest,f'{results} {round(faceDis[0],2)} ',(50,50),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),3)
